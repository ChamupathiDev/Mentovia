...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/resources/file/**").permitAll()
                        .requestMatchers("/users/**").authenticated()
                        .requestMatchers("/posts/**").authenticated()
                        .requestMatchers("/messages/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/resources").authenticated()
                        .requestMatchers(HttpMethod.GET, "/resources/{id}").authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(Arrays.asList("Authorization", "Content-Range", "Content-Length", "Content-Type"));
